...
@section('content')
        ...
        <div class="container-fluid contact py-6 collapse"  id="bookingForm2" style="padding-top:0 !important;">
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.6s">
                    <small class="d-inline-block fw-bold text-white text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Services</small>
                ...
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-primary px-5 py-3 rounded-pill" id="ConfirmBooking" >Envoyer</button>
                </div>
            </div>
        </div>
        <!-- Book Us End -->
        ...
        <div class="modal fade" id="ModalService" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    ...
                    <span aria-hidden="true"><i class="fa fa-x" data-dismiss="modal" aria-label="Close" aria-hidden="true"></i></span>
                </div>
