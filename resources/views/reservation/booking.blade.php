...
@section('content')
        ...
        <div class="container-fluid bg-light py-6 my-6 mt-0">
            <div class="container text-center animated bounceInDown">
                <h1 class="display-1 mb-4">Réservation</h1>
                <ol class="breadcrumb justify-content-center mb-0 animated bounceInDown">
                    <li class="breadcrumb-item"><a href="{{ url ('/')}}">Accueil</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item text-dark" aria-current="page">Réservation</li>
                </ol>
            </div>
        </div>
        <!-- Hero End -->
              ...
              <!-- Events Start -->
        <div class="container-fluid event py-6" style="margin-top: 0 !important;">
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Catalogue de Soirées</small>
                    <h1 class="display-5 mb-5">Les soirées pris en charge</h1>
                </div>
                    ...
                    <div class="col-10">
                        <div class="border-bottom border-top border-primary bg-light py-5 px-4">
                            <div class="text-center">
                                ...
                                <h1 class="display-5 mb-5">Reserver nos services</h1>
                            </div>
                            <div class="row g-4 form">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-primary px-5 py-3 rounded-pill">Suivant</button>
                                </div>
                            </div>
                        </div>
                    </div>
