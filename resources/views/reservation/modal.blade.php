        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                        ...
                        <table width="100%">
                            @foreach ($details as $detail)
                                ...
                                <tr class="Modal_tr">
                                    ...
                                    <td class="Modal_td">
                                        <div>
                                            <input class="Modal_input" value="{{$details[0]->idservices}}" type="checkbox" />
                                            <span></span>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('backBooking') }}"><button type="button" class="btn btn-primary"
                            id="saveButton">Enregistrer</button></a>
                </div>
            </div>
        </div>
    </div>
