                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-1.jpg') }}" alt="">
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.3s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-2.jpg') }}" alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.5s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-3.jpg') }}" alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.7s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-4.jpg') }}" alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-5.jpg') }}" alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.3s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-6.jpg') }}" alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Wedding</h4>
                                    ...
                                    <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.5s">
                                        <div class="event-img position-relative">
                                            <img class="img-fluid rounded w-100"
                                                src="{{ asset('assets/img/event-7.jpg') }}" alt="">
                                            <div class="event-overlay d-flex flex-column p-4">
                                                <h4 class="me-auto">Buffet</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <img src="{{ asset('assets/img/menu-01.jpg') }}"
                                    class="img-fluid rounded-circle border border-primary p-2" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('assets/img/menu-02.jpg') }}"
                                    class="img-fluid rounded-circle border border-primary p-2" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('assets/img/menu-03.jpg') }}"
                                    class="img-fluid rounded-circle border border-primary p-2" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('assets/img/menu-04.jpg') }}"
                                    class="img-fluid rounded-circle border border-primary p-2" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('assets/img/menu-05.jpg') }}"
                                    class="img-fluid rounded-circle border border-primary p-2" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('assets/img/menu-06.jpg') }}"
                                    class="img-fluid rounded-circle border border-primary p-2" alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <span class="text-light"><a href="#"><i
                                class="fas fa-copyright text-light me-2"></i>ASMM</a>, All right
                        reserved.</span>
                </div>
